...
let Node = createjs.promote(Node, "Container");
...
Panel = createjs.promote(Panel, "Node");
...
let PanelElement = createjs.promote(PanelElement, "Container");
...
let NodeContainer = createjs.promote(NodeContainer, "Container");